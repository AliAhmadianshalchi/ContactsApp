...
//    func didUpdateContact(_ contactManager: ContactManager, contact: Contact)
...
//    
//       
//       func parseJSON(_ contactData: Data) -> Contact? {
...
//               
//               let contact = Contact(name: name, id: id, companyName: companyName, isFavorite: isFavorite, smallImageURL: smallImageURL, largeImageURL: largeImageURL, emailAddress: emailAddress, birthdate: birthdate, work: workPhone, home: homePhone, mobile: mobilePhone, street: street, city: city, state: state, country: country, zipCode: zipCode)
//               return contact
//           } catch {
